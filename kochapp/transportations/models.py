...
class Cargo(models.Model):
    ...
    volume = models.FloatField(null=True, help_text="Volume is optional field")
    length = models.FloatField(null=True, help_text="Length is optional field")
    width = models.FloatField(null=True, help_text="Width is optional field")
    height = models.FloatField(null=True, help_text="Height is optional field")
